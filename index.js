...
app.post("/", (req, res) => {
    ...
    let frame = new Buffer(req.body.photo, "base64");
    frame = cv.imdecode(frame);
    ...
    verticesWithValidAngle.forEach((v) => {
        ...
        resizedImg.drawEllipse(new cv.RotatedRect(v.pt, new cv.Size(20, 20), 0), { color: red, thickness: 2 });
        result.drawEllipse(new cv.RotatedRect(v.pt, new cv.Size(20, 20), 0), { color: red, thickness: 2 });
    });
